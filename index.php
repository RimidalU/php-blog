    ...
    <div class="container">
        ...
        <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                <h1 class="display-4 font-italic">Title of big blog post</h1>
                <p class="lead my-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure expedita sunt odit quasi perferendis magni optio neque? Esse dolore accusamus quia expedita!</p>
