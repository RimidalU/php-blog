        ...
        <main role="main" class="">
            <div class="row justify-content-center">
                <div class="col-md-4 bg-light p-4 my-5">
                    ...
                    <form action="./utils/loginToDB.php" method="post" id="subscribe" class="border p-2">
                ...
                <?php
                if ($_SESSION['checkAuthMessage']) {
                    $toastMessage = $_SESSION['checkAuthMessage'];
                    $alertClass  = $_SESSION['alertClass'];

                    require './components/Alert.php';
                }
                unset($_SESSION['checkAuthMessage'])
                ?>
            </div>
        </main>
